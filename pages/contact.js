    ...
    <div className="container mx-auto lg:mt-0 w-screen lg:h-screen mt-4">
      <main className="flex flex-col justify-center items-center h-full w-full lg:mt-0 mt-24 mb-16">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div
            className="w-80 h-32 border border-black lg:hover:border-purple-700 bg-white lg:hover:text-purple-700 rounded-lg cursor-pointer flex items-center lg:hover:transform lg:hover:scale-110 transition active:border-purple-700 active:text-purple-700 ease-in-out"
